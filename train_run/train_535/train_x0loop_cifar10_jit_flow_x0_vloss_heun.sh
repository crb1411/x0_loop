#!/usr/bin/env bash
# Usage:
#   bash train_run/train_535/train_x0loop_cifar10_jit_flow_x0_vloss_heun.sh [ckpt.pt] [extra x0loop.train args...]
# Logs:
#   runs/cifar10/flow/jit/x0target_vloss_heun/<timestamp>/logs/launcher.log
