...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=20 max_cfg=2.3 schedule=constant power= GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
