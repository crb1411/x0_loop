...
EXP="heun_s20_maxcfg2p6_power_p0p5"
...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=20 max_cfg=2.6 schedule=power_decay power=0.5 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
