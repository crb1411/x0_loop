...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=16 max_cfg=2.25 schedule=constant power= GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
