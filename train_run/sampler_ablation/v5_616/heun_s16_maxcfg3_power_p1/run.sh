...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=16 max_cfg=3.0 schedule=power_decay power=1.0 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
