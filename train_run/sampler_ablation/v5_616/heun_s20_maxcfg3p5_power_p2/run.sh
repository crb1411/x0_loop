...
EXP="heun_s20_maxcfg3p5_power_p2"
...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=20 max_cfg=3.5 schedule=power_decay power=2.0 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
