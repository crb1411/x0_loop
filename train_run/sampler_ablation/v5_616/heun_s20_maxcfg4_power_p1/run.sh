...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=20 max_cfg=4.0 schedule=power_decay power=1.0 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
