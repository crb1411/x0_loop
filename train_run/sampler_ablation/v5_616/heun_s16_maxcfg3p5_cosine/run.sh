...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=heun steps=16 max_cfg=3.5 schedule=cosine_decay power= GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
