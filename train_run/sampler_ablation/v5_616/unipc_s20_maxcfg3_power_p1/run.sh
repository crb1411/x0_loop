...
EXP="unipc_s20_maxcfg3_power_p1"
...
echo "[sampler_ablation_v5_616] exp=${EXP} sampler=unipc steps=20 max_cfg=3.0 schedule=power_decay power=1.0 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
