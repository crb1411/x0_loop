...
Each experiment gets its own folder under train_run/sampler_ablation/<exp>/ with:
...
Output metrics land under: /data/seek/aigc/x0_loop/runs/sampler_ablation/<exp>/
"""
...
OUT_BASE = "/data/seek/aigc/x0_loop/runs/sampler_ablation"
NUM_SAMPLES = 10000
BATCH_SIZE = 256
...
EXP="{exp}"
CKPT="{ckpt}"
EVAL_CFG="${{ROOT}}/train_run/sampler_ablation/${{EXP}}/eval.yaml"
