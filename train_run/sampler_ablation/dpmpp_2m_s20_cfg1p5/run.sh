...
OUT_DIR="/data/seek/aigc/x0_loop/runs/sampler_ablation/${EXP}"
...
echo "[sampler_ablation] exp=${EXP} sampler=dpmpp_2m steps=20 cfg=1.5 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
