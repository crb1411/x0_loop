...
OUT_DIR="/data/seek/aigc/x0_loop/runs/sampler_ablation/v2_616/${EXP}"
...
echo "[sampler_ablation_v2_616] exp=${EXP} sampler=dpmpp_2m steps=16 cfg=2.25 GPU=${CUDA_VISIBLE_DEVICES}" | tee -a "${LOG_FILE}"
