#!/usr/bin/env bash
# Usage:
#   bash train_run/train_x0loop_oneclick.sh [ckpt.pt] [extra x0loop.train args...]
# Logs:
#   runs/launcher_logs/train_x0loop_oneclick/<timestamp>/logs/launcher.log
...
LOG_DIR="runs/launcher_logs/train_x0loop_oneclick/${X0LOOP_RUN_TIMESTAMP}/logs"
mkdir -p "${LOG_DIR}"
