#!/usr/bin/env bash
# Usage:
#   bash train_run/ablations/cifar10_flow_x0_vloss/train_dit_logitnormal_pmean_0p8_pstd_0p8.sh [ckpt.pt] [extra x0loop.train args...]
set -euo pipefail

DIR="$(cd "$(dirname "$0")" && pwd)"

MODEL_NAME="dit"
ABLATION_TAG="logitnormal_pmean_0p8_pstd_0p8"
