#!/usr/bin/env bash
# Usage:
#   bash train_run/ablations/cifar10_flow_x0_vloss/train_jit_logitnormal_target_weight_gridmix_p0p8.sh [ckpt.pt] [extra x0loop.train args...]
set -euo pipefail

DIR="$(cd "$(dirname "$0")" && pwd)"

MODEL_NAME="jit"
ABLATION_TAG="logitnormal_target_weight_gridmix_p0p8"
...
EXTRA_SETS=(
  ...
  --set "time_sampler.grid_mix_prob=0.8"
