...
COMMON_ARGS=(
  ...
  --set "gen_eval.every_steps=10000"
  --set "gen_eval.num_samples=5000"
  --set "gen_eval.batch_size=128"
  --set "gen_eval.steps=20"
  --set "gen_eval.sampler=heun"
  --set "gen_eval.guidance_scale=3.0"
  --set "gen_eval.metrics.ppl=false"
  --set "gen_eval.final.enabled=true"
  --set "gen_eval.final.num_samples=20000"
  --set "gen_eval.final.steps=50"
  --set "gen_eval.final.sampler=heun"
)
